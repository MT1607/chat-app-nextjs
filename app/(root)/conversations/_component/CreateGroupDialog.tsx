...
const createGroupFormSchema = z.object({
  ...
  members: z
    .string()
    .array()
    .min(1, { message: "You need to add at least one member to the group" }),
});
    ...
    <Dialog>
      ...
      <DialogContent className="block">
        <DialogHeader>
          ...
          <DialogDescription>Add your friend to start</DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
                ...
                {friends
                  ...
                  .map((friend) => {
                    return (
                      <div
                        key={friend._id}
                        className="flex flex-col items-center gap1"
                      >
