...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!currentUser) {
      throw new ConvexError("User not found 11");
    }
    ...
    if (!receiver) {
      throw new ConvexError("User can't not be found");
    }
...
export const deny = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!currentUser) {
      throw new ConvexError("User not found 12");
    }
...
export const accept = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!currentUser) {
      throw new ConvexError("User not found 13");
    }
